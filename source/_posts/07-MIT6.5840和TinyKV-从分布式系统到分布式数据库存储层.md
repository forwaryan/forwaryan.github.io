...
date: "2026-07-06 10:06:00"
updated: "2026-06-02 12:50:00"
permalink: "2026/07/06/mit65840-tinykv-distributed-storage/"
categories:
  - "分布式系统"
tags:
  - "MIT 6.5840"
...
<figure>
  <img src="/images/posts/mit65840-tinykv/overview-compare.png" alt="MIT 6.5840 和 TinyKV 的整体对比" style="max-width:100%">
</figure>
...
TinyKV 可以当成一条完整的数据库存储层训练线。它从一个能读写 BadgerDB 的单机 KV 开始，往上加 Raft、Region、Scheduler，最后再加 MVCC 和 Percolator 风格事务。

我更喜欢按系统问题来读它：数据先怎么落盘，再怎么复制，容量不够时怎么拆分，多个客户端并发读写时怎么给出稳定语义。这样看，Lab 之间不是孤立作业，而是一层层往上搭的存储系统。

<figure class="tinykv-svg-figure">
  <a href="/images/posts/tinykv-labs/tinykv-doc-coverage.png" target="_blank" rel="noopener"><img src="/images/posts/tinykv-labs/tinykv-doc-coverage.png" alt="TinyKV 本地文档和博客覆盖关系"></a>
  <figcaption>本地 TinyKV 文档已经收敛到这篇总览、Lab 系列和面经索引里。</figcaption>
</figure>
...
| Lab | 系统问题 | 实现重心 | 博客文章 |
| --- | --- | --- | --- |
| Lab1 | 单机数据怎么可靠读写 | `StandaloneStorage`、Raw KV API、Badger 封装 | [StandaloneKV](/2026/07/06/tinykv-lab1-standalonekv/) |
| Lab2 | 多副本怎么按同一顺序执行 | Raft、Ready、raftstore、snapshot | [RaftKV](/2026/07/06/tinykv-lab2-raftkv/) |
| Lab3 | key 空间怎么横向拆分和调度 | Region、Peer、Store、Scheduler | [Multi-RaftKV](/2026/07/06/tinykv-lab3-multiraftkv/) |
| Lab4 | 并发读写怎么有事务语义 | MVCC、lock/write/default、Percolator | [Transactions](/2026/07/06/tinykv-lab4-transactions/) |
| 面试 | 把问题落回具体 Lab | 面经索引、问题反查、回答锚点 | [面经索引](/2026/07/06/tinykv-interview-experience-index/) |
...
阅读材料也不用从第一条一路啃完。更舒服的方式是跟着 Lab 走，做到哪一层，就补哪一层的背景材料：

<figure class="tinykv-svg-figure">
  <a href="/images/posts/tinykv-labs/tinykv-reading-stack.png" target="_blank" rel="noopener"><img src="/images/posts/tinykv-labs/tinykv-reading-stack.png" alt="TinyKV 阅读清单按系统层次排列"></a>
...
<figure>
  <img src="/images/posts/mit65840-tinykv/mit65840-flow.png" alt="MIT 6.5840 从 MapReduce 到 ShardKV 的主线" style="max-width:100%">
</figure>
...
<figure>
  <img src="/images/posts/mit65840-tinykv/tinykv-architecture.png" alt="TinyKV raftstore 与 Multi-Raft 架构" style="max-width:100%">
</figure>
...
<figure>
  <img src="/images/posts/mit65840-tinykv/mvcc-percolator.png" alt="TinyKV MVCC 和 Percolator 事务流程" style="max-width:100%">
</figure>
